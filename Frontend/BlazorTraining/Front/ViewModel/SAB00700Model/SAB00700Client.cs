...
{
    public class SAB00700Client : R_BusinessObjectServiceClientBase<SAB00700DTO>, ISAB00700
    {
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrl";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/SAB00700";

        public SAB00700Client(string pcHttpClientName = DEFAULT_HTTP_NAME,
        ...
        public async Task<SAB00700ListDTO> GetAllCategoryAsync()
        {
            ...
            try
            {
                var loClient = R_HTTPClient.R_GetInstanceWithName(DEFAULT_HTTP_NAME);
